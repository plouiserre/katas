...
def test_compare_where_each_hand_have_differents_straights_with_second_hand_win():
    ...
    assert(Winner.SECOND_HAND == compare_two_straights_hands(first_hand, second_hand))    
...
def test_compare_where_each_hand_have_differents_straights_with_first_hand_win():
    ...
    assert(Winner.FIRST_HAND == compare_two_straights_hands(first_hand, second_hand))
...
def test_compare_where_each_hand_have_same_straights():
    ...
    assert(Winner.EQUALITY == compare_two_straights_hands(first_hand, second_hand))
