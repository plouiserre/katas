...
def test_compare_where_each_hand_have_differents_flush(): 
    ...
    assert(Winner.FIRST_HAND == compare_two_flush_hands(first_hand, second_hand))
...
def test_compare_where_each_hand_have_same_flush(): 
    ...
    assert(Winner.EQUALITY == compare_two_flush_hands(first_hand, second_hand))
...
def test_compare_randomise_flush_with_second_hand_win(): 
    ...
    assert(Winner.SECOND_HAND == compare_two_flush_hands(first_hand, second_hand))
