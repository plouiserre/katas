...
def test_compare_two_quinte_flush_first_hand_win():
    ...
    assert(Winner.FIRST_HAND == compare_two_quinte_flushs_hands(first_hand, second_hand))
...
def test_compare_two_quinte_flush_second_hand_win():
    ...
    assert(Winner.SECOND_HAND == compare_two_quinte_flushs_hands(first_hand, second_hand))
